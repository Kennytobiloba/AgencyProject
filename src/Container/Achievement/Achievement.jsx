...
const Achievement = () => {
  return (
    ...
    <div className=' pb-[4rem]   xl:py-[6rem] xl:mt-16 px-[2rem] sm:px-[3rem]  lg:px-[10rem] max-w-screen-2xl mt-20 mx-auto my-14 flex justify-around lg:flex-row flex-col gap-8'>
