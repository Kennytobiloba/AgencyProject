...
const Customer = () => {
  return (
    <div className='bg-[#F5F7FA]' id="Testimonial">
      <div className='px-4 lg:px-10 max-w-screen-2xl mx-auto my-8 mt-[6rem] py-16'>
      ...
      <img src={customerImage} alt="" className=''  />
       ...
       <div className='flex flex-1 flex-col justify-start '>
         <p className='text-neutral-500 text-base font-medium font-[Inter] mb-4 leading-normal' >Maecenas dignissim justo eget nulla rutrum molestie. Maecenas lobortis sem dui, vel rutrum risus tincidunt ullamcorper. Proin eu enim metus. Vivamus sed libero ornare, tristique quam in, gravida enim. Nullam ut molestie arcu, at hendrerit elit. Morbi laoreet elit at ligula molestie, nec molestie mi blandit. Suspendisse cursus tellus sed augue ultrices, quis tristique nulla sodales. Suspendisse eget lorem eu turpis vestibulum pretium. Suspendisse potenti. Quisque malesuada enim sapien, vitae placerat ante feugiat eget. Quisque vulputate odio neque, eget efficitur libero condimentum id. Curabitur id nibh id sem dignissim finibus ac sit amet magna.</p>
         <h3 className='text-green-500 text-xl font-semibold font-[Inter] leading-7'>Tim Smith</h3>
         <p className='text-gray-400 mt-2 text-base font-normal mb-2 font-[Inter] leading-normal'>British Dragon Boat Racing Association</p>
